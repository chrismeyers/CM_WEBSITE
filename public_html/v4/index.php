...
<!-- ABOUT SECTION -->
        <div id="about-me" class="content">
            ...
            <div class="content-text">
                ...
                <ul>
                    <li class="li-filled">Java, C++, C#, PHP, HTML, CSS, Javascript, MySQL, C, Visual Basic, Python, Perl, 
                        MIPS assembly, Scheme (LISP dialect), Ada, Lua.</li>
                </ul>
        ...
        <div id="my-builds" class="content">
            ...
            <div class="content-text">
                    ...
                    <div class="build-info">
                        ...
                        <div class="build-specs">
                            ...
                            <ul>
                                ...
                                <li><u>Cooling:</u> Cooler Master Hyper 212 Plus</li>
                    ...
                    <div class="build-info">
                        ...
                        <div class="build-specs">
                            ...
                            <ul>
                                ...
                                <li><u>Cooling:</u> Cooler Master Hyper 212 EVO</li>
                ...
                <div class="build">
                    ...
                    <div class="build-info">
                        <div class="build-pic">
                            <a href="images/builds/myBuild2016_liquid.jpg" class="fancybox" title="My Computer 2016">
                                <img src="images/builds/myBuild2016_liquid.jpg" 
                                     class="build-pic-img-port"
                        ...
                        <div class="projDesc">
                            <dl>
                                ...
                                <dt><b>Description:</b></dt>
                                    ...
                                    website, you can use <a href="http://chrismeyers.info/projects/LoL_player_data/web/main.php?name=Moshi&region=na" class="fancytxt" target="_blank">my account</a>
