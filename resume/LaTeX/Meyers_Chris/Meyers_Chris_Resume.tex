...
% BEGIN Experience
  ...
  \begin{itemize*}
    \item Designed, developed, and tested solutions in CMMI Level 5 for the U.S. Navy's real-time, \break mission critical Aegis Ballistic Missile Defense (BMD) system beginning as an intern (Mar -- May 2015).
...
% BEGIN TechnicalSkills
  ...
  \item Experience developing websites and web apps using languages and technologies such as the LAMP stack (Linux, Apache, MySQL, PHP), Flask (Python web framework), and JavaScript (jQuery, \break AngularJS).
  \item Experience developing Command Line applications using Python.
