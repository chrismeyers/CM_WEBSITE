...
% BEGIN Experience
  ...
  \begin{itemize*}
    ...
    \item Designed and implemented internal automation tools that include an app build/delivery \break system and a weekly time report generation system.
  \end{itemize*}
  ...
  \begin{itemize*}
    \item Designed, developed, and tested solutions in CMMI Level 5 for the U.S. Navy's real-time, \break mission critical Aegis Ballistic Missile Defense (BMD) system (intern from Mar -- May 2015).
