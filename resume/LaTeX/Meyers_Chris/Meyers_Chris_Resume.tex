...
% BEGIN Experience
  ...
  \begin{itemize*}
    \item Designed, developed, and tested solutions in CMMI Level 5 for the U.S. Navy's real-time, mission critical Aegis Ballistic Missile Defense (BMD) system (intern from Mar -- May 2015).
